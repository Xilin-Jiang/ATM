...
young_group <- read.table("/users/mcvean/xilin/xilin/Multimorbidity-biobank/important_LCV1.txt",quote = '', sep = '\t', header = F)
old_group <- read.table("/users/mcvean/xilin/xilin/Multimorbidity-biobank/important_LCV2.txt",quote = '', sep = '\t', header = F)
...
trait1File=paste0("/users/mcvean/xilin/xilin/Multimorbidity-biobank/causality_analysis/", ds_id1,"_topic", topic_id1,"/", ds_id1, "_topic", topic_id1, "_matching_topic.sumstats.gz",sep="")

trait2File=paste0("/users/mcvean/xilin/xilin/Multimorbidity-biobank/causality_analysis/", ds_id2,"_topic", topic_id2,"/", ds_id2, "_topic", topic_id2, "_matching_topic.sumstats.gz",sep="")
...
save(LCV_save, 
     file = paste0("/users/mcvean/xilin/xilin/Multimorbidity-biobank/causality_analysis/LCV_results/topic_match", 
