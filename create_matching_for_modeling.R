...
# note this is the file for matching everything. For matching specific subtypes see 
typeds <- data.frame(kmCluster = 1, eid)
...
write.table(control_for_gwas, paste("Association_analysis/", ds_id,"/",ds_id, "_control.txt",sep=""), sep="\t", col.names = FALSE, row.names = FALSE)
write.table(case, paste("Association_analysis/", ds_id,"/",ds_id, "_case.txt",sep=""), sep="\t", col.names = FALSE, row.names = FALSE)
write.table(DataGWAS, paste("Association_analysis/", ds_id,"/",ds_id, "_pheno_over_age.txt",sep=""), sep="\t", col.names = FALSE, row.names = FALSE)
