...
write.table(control_for_gwas, paste0("/users/mcvean/xilin/xilin/Multimorbidity-biobank/causality_analysis/", ds_id,"_topic", topic_id,"/", ds_id, "_topic", topic_id, "_matching_topic_ctrl.txt",sep=""), sep="\t", col.names = FALSE, row.names = FALSE)
write.table(case, paste0("/users/mcvean/xilin/xilin/Multimorbidity-biobank/causality_analysis/", ds_id,"_topic", topic_id,"/", ds_id, "_topic", topic_id, "_matching_topic_case.txt",sep=""), sep="\t", col.names = FALSE, row.names = FALSE)
write.table(DataGWAS, paste0("/users/mcvean/xilin/xilin/Multimorbidity-biobank/causality_analysis/", ds_id,"_topic", topic_id,"/", ds_id, "_topic", topic_id, "_matching_topic_pheno.txt",sep=""), sep="\t", col.names = FALSE, row.names = FALSE)
