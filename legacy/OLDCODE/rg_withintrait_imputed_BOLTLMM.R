...
young_group <- read.table("/users/mcvean/xilin/xilin/Multimorbidity-biobank/BOLT_LMM_subtype_list.txt",quote = '', sep = '\t', header = F)
old_group <- read.table("/users/mcvean/xilin/xilin/Multimorbidity-biobank/BOLT_LMM_subtype_list.txt",quote = '', sep = '\t', header = F)
# ######################################
...
trait1File=paste0("/users/mcvean/xilin/xilin/Multimorbidity-biobank/LDSC_SEG/", ds_id1,"_topic", topic_id1,"/", ds_id1, "_topic", topic_id1, ".bgen.sumstats.gz",sep="")

trait2File=paste0("/users/mcvean/xilin/xilin/Multimorbidity-biobank/LDSC_SEG/", ds_id2,"_topic", topic_id2,"/", ds_id2, "_topic", topic_id2, ".bgen.sumstats.gz",sep="")
...
save(LCV_save, 
     file = paste0("/users/mcvean/xilin/xilin/Multimorbidity-biobank/causality_analysis/imputed_SNP_results/boltlmm_imputed_sumstat", 
