...
for(k in 1:K_number){
  ...
  write.table(control_for_gwas, paste("Association_analysis/", ds_id,"/",ds_id, "subtp_", k, "_control.txt",sep=""), sep="\t", col.names = FALSE, row.names = FALSE)
  write.table(case, paste("Association_analysis/", ds_id,"/",ds_id, "subtp_", k, "_case.txt",sep=""), sep="\t", col.names = FALSE, row.names = FALSE)
  write.table(DataGWAS, paste("Association_analysis/", ds_id,"/",ds_id, "subtp_", k, "_pheno_over_age.txt",sep=""), sep="\t", col.names = FALSE, row.names = FALSE)
}
